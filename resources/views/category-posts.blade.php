...
@push('css')
    ...
    <style>
        .slider {
            height: 400px;
            width: 100%;
            background-image: url("{{Storage::disk('public')->url('category/'.$category->cate_image)}}");
...
<div class="slider display-table center-text">
    <h1 class="title display-table-cell"><b>{{ $category->cate_name }}</b></h1>
</div><!-- slider -->
