                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-danger waves-effect" type="button" onclick="removePost({{ $post->post_id }})" style="margin: 2px;">
                                        <i class="material-icons">delete</i>
                                    </button>
                                    <form id="remove-form-{{ $post->post_id }}" action="{{ route('post.favorite',$post->post_id) }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
                                </td>
                            </tr>
