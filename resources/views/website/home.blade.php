...
@push('css')
    <link href="{{asset('contents/website')}}/front-page-category/css/styles.css" rel="stylesheet">
    <link href="{{asset('contents/website')}}/front-page-category/css/responsive.css" rel="stylesheet">
@endpush
    ...
    <div class="swiper-container position-static" data-slide-effect="slide" data-autoheight="false"
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a class="slider-category" href="{{ route('category.posts', $category->cate_slug) }}">
                <div class="blog-image"><img src="{{Storage::disk('public')->url('category/slider/'.$category->cate_image)}}" alt="Blog Image"></div>

                    <div class="category">
                        <div class="display-table center-text">
                            <div class="display-table-cell">
                                <h3><b>{{$category->cate_name}}</b></h3>
                            </div>
                        </div>
                    </div>
